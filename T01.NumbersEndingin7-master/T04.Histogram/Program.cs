...
namespace T04.Histogram
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            double percentConverter1 = 1.0 * p1 / numbers * 100;
            double percentConverter2 = (double)p2 / numbers * 100;
            double percentConverter3 = 1.0 * p3 / numbers * 100;
            double percentConverter4 = (double)p4 / numbers * 100;
            double percentConverter5 = 1.0 * p5 / numbers * 100;
